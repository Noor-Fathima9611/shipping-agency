...
(function ($) {
  ...
  $(document).ready(function () {
    ...
    $(".gi-footer-heading .gi-heading-res").click(function () {
  ...
  $(document).ready(function () {
    $(".gi-sb-block-content .gi-ship-title").click(function () {
  ...
  $(document).ready(function () {
    ...
    $(".gi-sidebar-title .gi-sidebar-res").click(function () {
      // alert();
  ...
  $(document).ready(function () {
    $(".gi-pro-variation-content ul li").click(function () {
      $(this).addClass('active').siblings().removeClass('active');
    });
  });
